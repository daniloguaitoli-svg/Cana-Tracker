...
import { num, casasDaUnidade } from "../format.js";

const CHAVE = "cana-tracker-alertas";
    ...
    <div>
      <div className="card">
        ...
        <p className="muted" style={{ fontSize: 12 }}>
          ...
          Lembre-se de que os indicadores semanais (etanol) e mensais (ATR) só mudam quando saem.
        </p>
      </div>
      ...
      {alertas.length === 0 ? (
        ...
        <div style={{ marginTop: "var(--s4)" }}>
          {alertas.map((a) => {
            ...
            const v = it?.valor;
            const casas = casasDaUnidade(it?.unidade);
            const disparado =
              ...
              <div className="row" key={a.id} style={{ cursor: "default" }}>
                <div className="rowmain">
                  ...
                  <div className="rowsub">
                    {a.cond === "acima" ? "Subir acima de" : "Cair abaixo de"} {num(a.alvo, casas)} {it?.moeda || ""}
                    {" · atual "}
                    {v != null ? num(v, casas) : "—"}
                  </div>
                </div>
