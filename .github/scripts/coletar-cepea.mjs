...
// queda geral os 16 indicadores falhariam um a um, e uma escada de espera por
// indicador manteria o job de pé por quase uma hora. Esgotado o orçamento, o
// resto falha rápido e a nova tentativa do workflow (15 min depois) assume.
...
async function lerWidget(id, tentativas = 5) {
