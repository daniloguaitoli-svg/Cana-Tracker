...
//
// Só o açúcar de Nova York e o câmbio têm série histórica gratuita. Os
// indicadores CEPEA (etanol e açúcar), o futuro de etanol da B3 e o preço do ATR
// não têm. Então, a cada leitura, guardamos um snapshot diário (um ponto por
// slug por dia) num arquivo JSON. Localmente isso persiste em
// ./data/snapshots.json; na Vercel cai em /tmp (efêmero — o histórico reinicia
// em cold starts). É o melhor esforço possível com fontes gratuitas, e está
// documentado assim para o usuário.
...
// Registra o valor do dia (idempotente por dia).
