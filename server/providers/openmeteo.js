// server/providers/openmeteo.js — clima das regiões canavieiras (gratuito, sem chave).
//
...
//
// Na cana o sinal tem duas leituras: seca no desenvolvimento derruba a
// produtividade (t/ha), mas seca durante a moagem AJUDA a colheita e concentra
// o ATR. Por isso o app mostra o desvio de chuva e deixa a leitura com quem
// conhece o calendário da safra.

const UA = { "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64)" };
const TTL_MS = 12 * 60 * 60 * 1000;
let cache = null; // { ts, out }

// Principais regiões canavieiras (uma cidade representativa de cada).
const REGIOES = [
  { nome: "Norte de SP", cidade: "Ribeirão Preto/SP", lat: -21.17, lon: -47.81 },
  { nome: "Centro de SP", cidade: "Piracicaba/SP", lat: -22.72, lon: -47.65 },
  { nome: "Triângulo Mineiro", cidade: "Uberaba/MG", lat: -19.75, lon: -47.93 },
  { nome: "Sul de Goiás", cidade: "Quirinópolis/GO", lat: -18.45, lon: -50.45 },
  { nome: "Noroeste do Paraná", cidade: "Maringá/PR", lat: -23.42, lon: -51.94 },
  { nome: "Zona da Mata (NE)", cidade: "Maceió/AL", lat: -9.67, lon: -35.74 },
];
